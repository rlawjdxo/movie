...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
	 ...
	 -->
				<tr>
					<th>영화 이름</th>
					<td><input type="text" name="mName" size="40" class = "listbox" /></td>
				</tr>
				<tr>
					<th>영화 장르</th>
					<td><select name="mCategory" id="Mcategory" class = "listbox">
				...
				<tr>
					<th>감독</th>
					<td><input type="text" name="mDirector" size="40" class = "listbox" /></td>
				</tr>
				<tr>
					<th>배우</th>
					<td><input type="text" name="mActors" size="40" class = "listbox" /></td>
				</tr>
				<tr>
					<th>줄거리</th>
					<td><textarea rows="20" cols="40" name="mStory"
							placeholder="100글자 이내" class = "listbox"></textarea></td>
				</tr>

				<tr>
					<th>관람연령</th>
					<td><select name="mAge" id="Mage" class = "listbox">
				...
				<tr>
					<th>개봉일</th>
					<td><input type="date" name="mDate" size=33 class = "listbox" /> <br /></td>
				</tr>
				<tr>
					<th>상영시간</th>
					<td><input type="text" name="mRtime" size="40" class = "listbox" /></td>
				</tr>
				<tr >
					<th>메인포스터</th>
					<td class="filebox">
				...
				<tr>
					<th colspan="2"><input type="submit" value="등록" class = "listbox1" /></th>
				</tr>
