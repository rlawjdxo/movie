...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
							...
							<table class="listbox" id="listbox">
								<tr>
									<th>아이디</th>
									<td style="color: black;">${view.euId}</td>
								</tr>
								<c:if test="${loginId==view.euId || loginId=='admin'}">
								<tr>
									<th>비밀번호</th>
									<td style="color: black;">${view.euPw}</td>
								</tr>
								</c:if>
								<tr>
									<th>이름</th>
									<td style="color: black;">${view.euName}</td>
								</tr>

								<tr>
									<th>생년월일</th>
									<td style="color: black;">${view.euBirth}</td>
								</tr>

								<tr>
									<th>성별</th>
									<td style="color: black;">${view.euGender}</td>
								</tr>

								<tr>
									<th>이메일</th>
									<td style="color: black;">${view.euEmail}</td>
								</tr>

								<tr>
									<th>전화번호</th>
									<td style="color: black;">${view.euPhone}</td>
								</tr>

								<tr>
									<th>주소</th>
									<td style="color: black;">${view.euAddr}</td>
								</tr>
