							...
							<caption>회원정보 페이지</caption>
									...
									<c:forEach var="list" items="${euList}">
										<tr>
											...
											<td style="color: black;">${list.euName}</td>	
											<td style="color: black;">${list.euBirth}</td>									
											<td style="color: black;">${list.euGender}</td>
											<td style="color: black;">${list.euEmail}</td>
											<td style="color: black;">${list.euPhone}</td>
										</tr>
									</c:forEach>
