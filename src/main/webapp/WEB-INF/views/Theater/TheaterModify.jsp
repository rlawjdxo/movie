...
<form action="theaterModify" method="POST">
<input type="hidden" name="emgCode" value="${modify.emgCode}"/>
<table class="listbox" id="listbox">
<caption>극장 정보 수정</caption>
	<tr>
		<th>극장명</th>
		<td><input type="text" name="emgName" size="20" value="${modify.emgName}" class="listbox"/></td>
	</tr>	
	<tr>
		<th>총 좌석수</th>
		<td><input type="text" name="emSeat" value="${modify.emSeat}" class="listbox"/></td>
	</tr>
	<tr>
		<th>영화 관람료</th>
		<td><input type="text" name="emCost" value="${modify.emCost}" class="listbox"/></td>
	</tr>
	...
	<tr>
		<th>대중교통안내</th>
		<td><textarea rows="20" cols="40" name="emTraffic" value="${modify.emTraffic}" class="listbox"/></textarea></td>
	</tr>	
	<tr>
		<th colspan="2">
