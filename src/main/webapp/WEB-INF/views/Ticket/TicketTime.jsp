...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
		<form action="emgtime" method="POST" enctype="multipart/form-data">
			<input type="hidden" name="bWriter" value="${loginId}" />
			<table class="listbox" id="listbox">
				<caption>영화 날짜 시간 등록</caption>
				<!-- 
		<tr>
			<th>작성자</th>
	 ...
	 -->
				<tr>
					<th>영화 코드</th>
					<td><select name="mCode" class = "listbox">
				...
				<tr>
					<th>영화관 코드</th>
					<td>
					<select name="emgCode" class = "listbox">
				...
				<tr>
					<th >영화 날짜</th >
					<td><input type="date" name = "emsDate" class = "listbox"></td>
				</tr>
				<tr>
					<th>영화 시간</th>
					<td><input type="time" name = "emsTime" value="~" class = "listbox1">~<input type="time" name = "emsTime" class = "listbox1"></td>
				</tr>
