...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
		...
		<table class="listbox" id="listbox">
			...
			<tr>
				<th>상영정보코드</th>
				<td style="color: black;" >${tview.emsCode}</td>
			</tr>
			
			<tr>
				<th>영화코드</th>
				<td style="color: black;">${tview.MName}</td>
			</tr>
			<tr>
				<th>상영관코드</th>
				<td style="color: black;">${tview.emgName}</td>
			</tr>
			<tr>
				<th>상영날짜</th>
				<td style="color: black;">${tview.emsDate}</td>
			</tr>

			<tr>
				<th>상영시간</th>
				<td style="color: black;">${tview.emsTime}</td>
			</tr>
...
<script>
	$('#modify').click(function() {
		...
		location.href = "tmodifyForm?emsCode=${tview.emsCode}";

	});
	$('#delete').click(function() {

		location.href = "tDelete?emsCode=${tview.emsCode}";
